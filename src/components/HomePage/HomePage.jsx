  ...
  return (
    <div className='mb-6 homepage'>
      <div className='homepage__hero is-flex is-flex-direction-row is-align-items-center is-justify-content-center'>
        ...
        <div className="homepage__hero__photo"><img src={process.env.PUBLIC_URL + "assets/images/PhotoLaptopSmall_dviswi_c_scale,w_576.png"} alt='laptop' id='img' style={"background-image: url(../../../assets/images/PhotoLaptopSmall_dviswi_c_scale,w_576.png)"}/></div>
      </div>
      <AboutPage/>
